    ...
    //Eric Beeler
{
    public partial class Form1 : Form
    {
        ...
        private char _Resume = 'b';
        private Robot _robot = new Robot("Com6");//find correct port in order to communicate
        ...
        {//create display functions
            while (_capture.IsOpened)
            {
                ...
                //Do the same exact thing for the red line code
                ...
                //Merge both yellow and red to complete images
                ...
                //Split the yellow into 5 different pieces, in order to read for direction
